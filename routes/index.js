...
router.get(
  "/b/:board_slug",
  authMiddleware.addUserMeta,
  generalController.getBoardIndexPage,
);
...
router.get(
  "/b/:board_slug/new-post",
  authMiddleware.isSessionActive,
  postController.getNewPostPage,
);
router.post(
  "/b/:board_id/new-post",
  authMiddleware.isSessionActive,
...
); // html forms only does post for submission

// replies
router.get(
  "/p/:post_slug/new-reply",
  authMiddleware.isSessionActive,
  replyController.getNewReplyPage,
);
router.post(
  "/p/:post_id/new-reply",
  authMiddleware.isSessionActive,
